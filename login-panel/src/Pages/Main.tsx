...
export function Main() {
    ...
    return (
        <div className={`min-h-screen ${darkMode ? 'dark' : ''} bg-gradient-to-br from-blue-100 to-purple-200 dark:from-gray-800 dark:to-gray-900 text-gray-900 dark:text-white transition-colors duration-300`}>
            <header className="py-6 px-8 flex justify-between items-center bg-white bg-opacity-30 dark:bg-gray-800 dark:bg-opacity-30">
            ...
            <main className="container mx-auto px-4 py-12">
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    <div className="bg-white bg-opacity-50 dark:bg-gray-700 dark:bg-opacity-50 p-6 rounded-lg">
                ...
                <section className="text-center mb-16">
                    ...
                    <button className="bg-pink-500 hover:bg-pink-600 dark:bg-pink-600 dark:hover:bg-pink-700 text-white font-bold py-2 px-4 rounded-full transition">
                        Take a Tour
                    </button>
                </section>
                ...
                <div className="text-center">
                    <button
                        ...
                        className="bg-gray-500 hover:bg-gray-600 dark:bg-gray-600 dark:hover:bg-gray-700 text-white font-bold py-2 px-4 rounded transition"
                    >
            ...
            <footer className="bg-white bg-opacity-30 dark:bg-gray-700 dark:bg-opacity-30 py-8 px-4">
                <div className="container mx-auto flex flex-wrap justify-between items-center">
                    ...
                    <div className="w-full md:w-1/3 text-center mb-4 md:mb-0">
                        ...
                        <ul>
                            <li><a href="#about" className="hover:text-indigo-600 dark:hover:text-indigo-300 transition">About</a></li>
                            <li><a href="#contact" className="hover:text-indigo-600 dark:hover:text-indigo-300 transition">Contact</a></li>
                            <li><a href="#privacy" className="hover:text-indigo-600 dark:hover:text-indigo-300 transition">Privacy Policy</a></li>
                        </ul>
                    </div>
                    <div className="w-full md:w-1/3 text-center md:text-right">
                        <h4 className="text-lg font-semibold mb-2">Connect With Us</h4>
                        <div className="flex justify-center md:justify-end space-x-4">
                            <a href="#" className="text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-300 transition"><i className="fab fa-facebook"></i></a>
                            <a href="#" className="text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-300 transition"><i className="fab fa-twitter"></i></a>
                            <a href="#" className="text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-300 transition"><i className="fab fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
            </footer>
